...
const (
	...
	UserService_ProfileUser_FullMethodName = "/proto.UserService/ProfileUser"
	UserService_ListUsers_FullMethodName   = "/proto.UserService/ListUsers"
	UserService_CheckUser_FullMethodName   = "/proto.UserService/CheckUser"
)
...
func (c *userServiceClient) ProfileUser(ctx context.Context, in *ProfileUserRequest, opts ...grpc.CallOption) (*ProfileUserResponse, error) {
...
func (UnimplementedUserServiceServer) ProfileUser(context.Context, *ProfileUserRequest) (*ProfileUserResponse, error) {
...
func _UserService_ProfileUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ProfileUser(ctx, req.(*ProfileUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
